    ...
    <div class="entry-wrap">
        <header class="entry-header">
            ...
            <h1 class="entry-title">
                <?php if (function_exists('get_url_in_content')) { ?>
                <?php $content = get_the_content(); ?>
                <?php $has_url = get_url_in_content( $content ); ?>
                <?php if ($has_url) { ?>
                <a href="<?php echo $has_url; ?>" rel="bookmark"><?php the_title(); ?></a>
                <?php } else { ?>
                <?php the_title(); ?>
                <?php } ?>
                <?php } else { ?>
        ...
        <footer class="entry-meta">
            <span class="post-format">
                <i class="fa fa-link"></i> <a href="<?php echo esc_url( get_post_format_link( 'link' ) ); ?>"><?php echo get_post_format_string( 'link' ); ?></a>
            </span>
