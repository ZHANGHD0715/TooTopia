...
/*--------------------------------------------------------------------------------------
  ...
  */
  ...
  function bs_collapse( $atts, $content = null ) {
    ...
    return '<div class="panel panel-' . $type . '"><div class="panel-heading"><h3 class="panel-title"><a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion-' . $GLOBALS['collapsibles_count'] . '" href="#collapse_' . $GLOBALS['current_collapse'] . '_'. sanitize_title( $title ) .'">' . $title . '</a></h3></div><div id="collapse_' . $GLOBALS['current_collapse'] . '_'. sanitize_title( $title ) .'" class="panel-collapse collapse ' . $state . '"><div class="panel-body">' . do_shortcode($content) . ' </div></div></div>';
  }
...
function add_shortcodes() {
    ...
    add_shortcode('button-group', 'bs_button_group' );
    ...
    add_shortcode('list-group', 'bs_list_group' );
    add_shortcode('list-group-item', 'bs_list_group_item' );
    add_shortcode('badge', 'bs_badge' );
    add_shortcode('icon', 'bs_icon' );
    add_shortcode('icon_white', 'bs_icon_white' );
    add_shortcode('table', 'bs_table' );
    add_shortcode('table-wrap', 'bs_table_wrap' );
    ...
    add_shortcode('media-object', 'bs_media_object' );
    add_shortcode('media-body', 'bs_media_body' );
    ...
    add_shortcode('modal-footer', 'bs_modal_footer' );
}
